...
Public Class riddle2
    ...
    Private Sub riddle2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Text = Riddle1.count
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            query1 = "select sa from riddle_submitted where sa='4'"
            ...
            Else
                count = TextBox1.Text
                MsgBox("Incorrect. The correct answer is 4")
            End If
