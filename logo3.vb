...
Public Class logo3
    ...
    Private Sub logo3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Text = logo2.count
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            query1 = "select ls.sa from logo_submitted ls where ls.sa='NBC'"
        ...
        Catch ex As Exception
            MsgBox(ex.Message)
            MsgBox("Incorrect. The correct answer is NBC")
        End Try
        Me.Hide()
        logo4.Show()
    End Sub
