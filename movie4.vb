...
Public Class movie4
    ...
    Private Sub movie4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Text = movie3.count
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            query1 = "select sa from movie_submitted where sa='Cady'"
            ...
            Else
                count = TextBox1.Text
                MsgBox("Incorrect. The correct answer is Cady")
            End If
