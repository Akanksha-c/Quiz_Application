...
Public Class movie2
    ...
    Private Sub movie2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Text = movie1.count
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            query1 = "select sa from movie_submitted where sa='Raja Harischandra'"
            ...
            Else
                count = TextBox1.Text
                MsgBox("Incorrect. The correct answer is Raja Harischandra")
            End If
