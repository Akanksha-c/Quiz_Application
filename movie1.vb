...
Public Class movie1
    ...
    Private Sub movie1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Text = 0
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim dt As DataTable
        Try
            query2 = "Truncate table movie_submitted"
            ...
            query1 = "select sa from movie_submitted where sa='Eddie Murphy'"
            ...
            Else
                count = TextBox1.Text
                MsgBox("Incorrect. The correct answer is Eddie Murphy")
            End If
