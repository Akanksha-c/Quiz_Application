...
Public Class riddle4
    ...
    Private Sub riddle4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Text = riddle3.count
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            query1 = "select sa from riddle_submitted where sa='36'"
            ...
            Else
                count = TextBox1.Text
                MsgBox("Incorrect. The correct answer is 36")
            End If
